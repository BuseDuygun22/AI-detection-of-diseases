...
from saliency_map import generate_saliency_map
...
def main(args: argparse.Namespace, activeloop: bool = True) -> None:
    ...
    train_dataset = ImageDataset(BASE_DIR / "data/X_train.npy", BASE_DIR / "data/Y_train.npy")
    test_dataset = ImageDataset(BASE_DIR / "data/X_test.npy", BASE_DIR / "data/Y_test.npy")
...
if __name__ == "__main__":
    ...
    model_weights_path = "model_weights/" + os.listdir("model_weights")[0]
    image_data_path = "data/X_test.npy"
    label_data_path = "data/Y_test.npy"

    generate_saliency_map(model_weights_path, image_data_path, label_data_path)
